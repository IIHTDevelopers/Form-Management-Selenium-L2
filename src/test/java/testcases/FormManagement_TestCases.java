...
public class FormManagement_TestCases extends AppTestBase {
	...
	public void VerifyThatClickingOnRefreshButtonItsRefreshingAllTheEnteredDataInAllTheFields() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		Map<String, String> expectedData1 = new FileOperations().readExcelPOI(expectedDataFilePath, "userdetails");
//		RegisterPageInstance.fillTheForms(expectedData1);
	...
	public void verifyTitleOfNewTab() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "newTab_Title");
	...
	public void verifyTitleOfNewWindows() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "newWindow_Title");
	...
	public void verifyTitleOfMultipleWindows() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "newMultipleWindow_Title");
	...
	public void gotoInteractionTabclickOnDragandDropThenClickOnStaticThenValidateTitleOfThePage() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		//String expectedDataFilePath = testDataFilePath+"expected_data.json";
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "DragAndDropPage_Title");
	...
	public void verifyTextofAnyToggleActionInsideOfAccordionListMenu() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		Map<String, String> expectedData = new FileOperations().readExcelPOI(expectedDataFilePath, "PannelMessage");
	...
	public void verifyAutoCompleteTextBoxIsPresentOrNotAndPassThevalue() throws Exception {
		RegisterPageInstance = new FormManagement_Pages(driver);
		Map<String, String> expectedData1 = new FileOperations().readExcelPOI(expectedDataFilePath, "autoCompleteTextBox");
